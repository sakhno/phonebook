...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/t/bs/dt-1.10.11,se-1.1.2/datatables.min.css"/>
                ...
                <div class="col-sm-12 autowindow"style="display: none" id="contactformwindow">
                    <form class="form-horizontal" id="contactform">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input name="submit" class="btn btn-primary col-sm-12" type="submit" id="submitbutton" value="Сохранить">
                            </div>
                        </div>
